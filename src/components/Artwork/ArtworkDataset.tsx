...
function ArtworkDataset() {
  const artwork: ArtworkItem[] = [
    ...
    },
    {
      ...
      description: 'A quadraped spider-like robot that I made for a friend. His name is Timothy.',
      link: '',
    },
    {
    ...
    },
    {
      ...
      title: 'Pine Forest',
      description: 'A warm, pine forest with a small stream running through it.',
      link: '',
    },
    {
    ...
    },
    {
      ...
      title: 'Low Poly Medieval Castle Pack',
      description: 'An evening scene of the backside drawbridge of a castle.',
      link: '',
    },
    {
      image: images.CastleChurch,
      title: 'Low Poly Medieval Castle Pack',
      description: "The castle's church and graveyard, with light shining out the windows.",
      link: '',
    },
    {
    ...
    },
    {
      image: images.Monk,
      title: 'Fantasy Monk',
      description: 'A cool looking monk with a neat hat and weird glowy orbs of energy or something.',
      link: '',
    },
    {
